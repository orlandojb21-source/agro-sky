...
// aquí -- vive en cada Informe de Campo (ver validation/informesCampo.ts),
// porque una persona puede trabajar en más de un proyecto el mismo día y
// cada informe tiene su propia contabilidad de hectáreas.
