...
// Solo la ve jefe/soporte (ver la nota en planilla/page.tsx) -- un
...
//
// Colapsado por defecto (solo el título) para no ocupar espacio de
// entrada -- se despliega con un clic cuando se quiere revisar.
  ...
  return (
    <div className="rounded-xl border border-green-100 bg-white p-4 shadow-sm dark:border-green-900/40 dark:bg-green-950/10">
      ...
      >
        ...
        <span className="shrink-0 text-green-700/70 dark:text-green-300/70">{desplegado ? "▲" : "▼"}</span>
      </button>
